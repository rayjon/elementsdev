				...
				?>
					<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
							...
							<?php if ( ! has_post_thumbnail() ) : ?>
								<header class="entry-header">
									<div class="entry-header-wrapper">
										...
										<p>Crisaba is a web development studio based in Austin, TX serving the technical and creative needs of small businesses, agencies, professionals.</p>
						...
						<section class="how-we-help">
							<figure>
							   <img src="http://crisaba.com/wp-content/uploads/2016/09/website-maintenance.jpeg" alt="A photo of a tray mung bean sprouts growing in paper pots.">
						   </figure>
						...
						<section class="process">
							<div class="wrap wrapper">
								<header class="entry-header">
									...
									<p>Avoid bumps in the road by visualizing the destinations<br>
